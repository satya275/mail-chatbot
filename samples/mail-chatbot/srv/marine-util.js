...
async function callStatusService(path) {
  console.log('[MAIL] Calling status service', { destination: DESTINATION, url: path });
  ...
  try {
    ...
    console.log('[MAIL] Status service success', {
    ...
    console.error('[MAIL] Status service FAILED', {
